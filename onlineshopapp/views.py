...
class HomeView(ShopMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['myname'] = "Mariam Pipia"
        context['product_list'] = Product.objects.all().order_by("-id")
        return context
    
class AllProductsView(ShopMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if cart_id:
            ...
            # new item is added to cart
                ...
                cartproduct = CartProduct.objects.create(cart=cart_obj, product=product_obj, price=product_obj.selling_price, quantity=1, subtotal=product_obj.selling_price)
                cart_obj.total += product_obj.selling_price
                cart_obj.save()
        else:
...
class ManageCartView(ShopMixin, View):
    def get(self, request, *args, **kwargs):
        ...
        if action == "inc":
            ...
            pass
        return redirect("onlineshopapp:mycart")
...
class CheckOutView(ShopMixin, CreateView):
    ...
    success_url = reverse_lazy("onlineshopapp:home")
    ...
    def form_valid(self, form):
        ...
        if cart_id:
            ...
            return redirect("onlineshopapp:home")
    ...
    def dispatch(self, request, *args, **kwargs):
        if request.user.is_authenticated and Customer.objects.filter(user=request.user).exists():
            ...
            if request.user.customer != order.cart.customer:
                return redirect("onlineshopapp:customerprofile")
        else:
            return redirect("/login/?next=/profile/")
        return super().dispatch(request, *args, **kwargs)
...
class AdminLoginView(FormView):
    ...
    form_class = CustomerLoginForm
    success_url = reverse_lazy("onlineshopapp:adminpendingorders")
...
class AdminPendingOrdersView(AdminRequiredMixin, TemplateView):
...
class AdminOrderStatusChangeView(AdminRequiredMixin, View):
    def post(self, request, *args, **kwargs):
        ...
        order_obj.save()
        return redirect(reverse_lazy("onlineshopapp:adminorderdetail", kwargs={"pk": self.kwargs["pk"]}))